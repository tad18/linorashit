...
local SaveManager = {} do
	SaveManager.Folder = getgenv().settings_folder or "AstroClubSettings"
	SaveManager.Ignore = {}
	SaveManager.Parser = {
		Toggle = {
	...
	function SaveManager:BuildConfigSection(tab,disablecloudconfigs)
		...
		if not disablecloudconfigs then
			...
			local BrowserLIB = loadstring(game:HttpGet("https://raw.githubusercontent.com/tad18/AstroWorld/main/browserv2.lua"))()
			local Configs = game:GetService("HttpService"):JSONDecode(httprequest({Url = 'https://raw.githubusercontent.com/tad18/AstroWorld/main/configs.json'}).Body)['Configs']
			...
			local Blacklisted_Discord_Ids = loadstring(game:HttpGet("https://raw.githubusercontent.com/tad18/AstroWorld/main/blacklisted_ids.lua"))()
